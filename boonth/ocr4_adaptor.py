"""
ocr4 adaptor, used for testing

This module lets us test ocr4.py without having to know how ocr4.py works
internally.
...
def run_ocr(input_string):
    """Given a string, give it to ocr4 as a file, and return the
    output of ocr4 as a string."""
